# From https://github.com/alexherbo2/dotfiles/blob/master/.config/kak/autoload/user_modes/letter_case.kak
# Implementation reference: https://docs.rs/inflections/latest/src/inflections/case.rs.html
# NOTE- does not actually handle kebab-case conversions properly
...
map -docstring 'Title Case' global letter_case 't' ':convert_selected_text_to_title_case<ret>'
# map -docstring 'Title Case' global letter_case '.' ':convert_selected_text_to_title_case<ret>'
map -docstring 'camelCase'  global letter_case 'c' ':convert_selected_words_to_camel_case_style<ret>'
map -docstring 'PascalCase' global letter_case 'p' ':convert_selected_words_to_pascal_case_style<ret>'
map -docstring 'kebab-case' global letter_case 'k' ':convert_selected_words_to_kebab_case_style<ret>'
map -docstring 'kebab-case' global letter_case '<minus>' ':convert_selected_words_to_kebab_case_style<ret>'
