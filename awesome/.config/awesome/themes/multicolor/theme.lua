...
local lainiconsdir = fs.get_xdg_config_home() .. "/awesome/lain/icons"

local theme                                     = {}
theme.confdir                                   = fs.get_xdg_config_home() .. "/awesome/themes/multicolor/"
theme.wallpaper                                 = fs.get_xdg_data_home() .. "wallpapers/current/Deep_Space_72_Without_A_Logo.jpg"
-- theme.wallpaper                                 = theme.confdir .. "/wall.png"
theme.font                                      = "Lotion 10"
...
local cpu = lain.widget.cpu({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#e33a6e", cpu_now.usage .. "% CPU"))
    end
})
...
local memory = lain.widget.mem({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#e0da37", mem_now.perc .. "% Mem "))
    end
})
